...
<body>
	...
	<c:set var="message" value="안녕하세요, JSTL"/> <!-- self closing -->
	<p>메시지 : </p><c:out value="${message}"></c:out>
	
	<!-- IF -->
	<c:if test="${message != null}">
		<p>메시지 값이 null이 아닙니다. null 이면 tag 자체가 랜더링이 안됨..</p>
	</c:if>
	...
	<fmt:formatDate var="formattedDate" value="${now}" pattern="yyy-MM-dd HH:mm:ss"/>
